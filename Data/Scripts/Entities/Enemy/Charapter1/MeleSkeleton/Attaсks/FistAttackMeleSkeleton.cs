...
public partial class FistAttackMeleSkeleton : EnemyAttack
{
    ...
    public FistAttackMeleSkeleton(int damage, Vector2 enemyPosition, Vector2 targetPosition) : base(damage, 0.25, "res://Data/Textures/Entities/Enemys/Chapter1/WhiteCube.tscn")
    {
